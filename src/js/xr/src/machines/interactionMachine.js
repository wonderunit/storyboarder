...
const machine = Machine({
  ...
  guards: {
    ...
    eventHasSceneObjectIntersection: (context, event) => event.intersection != null && ['object', 'character', 'light', 'virtual-camera', 'image', 'attachable', 'group'].includes(event.intersection.type),
