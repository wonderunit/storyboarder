...
let commands = [
  ...
  ["Navigation", [
      ['<strong>Previous Board</strong>', keystrokeFor("Left")],
      ['<strong>Next Board</strong>', keystrokeFor("Right")],
  ...
  ["Tools", [
      ...
      ['Note Pen', keystrokeFor("5")],
      ['Eraser', keystrokeFor("6")],
      ['<strong>Clear All Layers</strong>', keystrokeFor("Backspace")],
      ['Clear Layer', keystrokeFor("Alt+Backspace")],
  ...
  ["View", [
      ['<strong>Cycle View Mode</strong>', keystrokeFor("Tab")],
      ['Reverse Cycle View Mode', keystrokeFor("Shift+Tab")],
