...
const ShotElement = React.memo((
    ...
    return <div className="shot-explorer-shot" style={{  minWidth:  ((defaultWidth * aspectRatio)) / 3 - paddingSize, maxWidth:  ((defaultWidth * aspectRatio)) / 3 - 40, height: (defaultWidth) / 3 }}>
