...
THREE.OutlineEffect = function ( renderer, parameters ) {
	...
	var defaultThickness = parameters.defaultThickness !== undefined ? parameters.defaultThickness : 0.005;
	var defaultColor = parameters.defaultColor !== undefined ? parameters.defaultColor : new THREE.Color( 0x555555 );
	var defaultAlpha = parameters.defaultAlpha !== undefined ? parameters.defaultAlpha : 0.1;
