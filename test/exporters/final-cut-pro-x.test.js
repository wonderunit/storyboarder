const exporterFcp = require('../../src/js/exporters/final-cut-pro-x.js')
...
let xml = exporterFcp.generateFinalCutProXXml(exporterFcp.generateFinalCutProXData(boardFileData, { boardAbsolutePath, outputPath }))
